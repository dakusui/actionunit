...
import static com.github.dakusui.actionunit.compat.actions.ForEach.Mode.SEQUENTIALLY;
import static com.github.dakusui.actionunit.compat.utils.InternalUtils.describe;
import static com.github.dakusui.actionunit.n.utils.InternalUtils.summary;
...
public interface CompatForEach<T> extends Action {
  ...
  class Builder<E> {
    ...
    private       ForEach.Mode        mode = SEQUENTIALLY;

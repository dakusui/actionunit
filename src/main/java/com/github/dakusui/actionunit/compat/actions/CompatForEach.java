...
public class CompatForEach<T> extends Nested.Base {
  ...
  public Composite getElements(Context context) {
    ...
    return CompatActionRunner.IgnoredInPathCalculation.Composite.create(CompatForEach.this.factory.create(Autocloseables.transform(dataSourceFactory.create(context), func)));
  }

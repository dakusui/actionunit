...
public abstract class CompatCommander<B extends CompatCommander<B>> extends Action.Builder<Action> implements Cloneable {
  ...
  public static CompatCommander<?> commander(String command) {
   ...
   * @see CompatCommander#composeCmd(Context)
   */
   ...
   * @see CompatCommander#toStream(Context)
   */
        ...
        .command(new Supplier<String>() {
          ...
          public String get() {
            return String.format(
                "%s %s",
                CompatCommander.this.program(),
                CompatCommander.this.formatOptions(option -> option.apply(context))
            );
          }
          ...
          public String toString() {
            return String.format(
                "%s %s",
                CompatCommander.this.program(),
                CompatCommander.this.formatOptions(stringSupplier -> {

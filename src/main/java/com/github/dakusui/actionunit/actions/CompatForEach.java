...
public interface CompatForEach<E> extends Action {
  ...
  class Builder<E> extends Action.Builder<CompatForEach<E>> {
    ...
    public CompatForEach<E> build() {
      return new CompatForEach<E>() {
        @Override
